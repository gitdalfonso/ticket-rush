    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                <a href="{{ url('/concerts/1') }}"
                   class="text-2xl font-black text-indigo-600 tracking-tighter hover:opacity-80">
                    TicketRush ⚡
                </a>
            </div>
            <div class="flex items-center space-x-4">
                <a href="{{ url('/concerts/1') }}" class="text-gray-500 hover:text-indigo-600 font-medium transition">Ver
                    Concierto</a>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 pb-12">
    ...
    @if($orders->isEmpty())
        <div class="bg-white rounded-lg shadow-lg p-12 text-center">
            ...
            <p class="mt-2 text-gray-500 max-w-sm mx-auto">Parece que no has comprado tickets para ningún evento. ¡No te
                quedes fuera!</p>
            <div class="mt-6">
                <a href="{{ url('/concerts/1') }}"
            ...
            @foreach($orders as $order)
                <div
                    ...
                    <div
                        ...
                        <span
                            class="text-white text-xs font-bold uppercase tracking-widest border border-white/30 rounded px-2 py-0.5">Orden #{{ $order->id }}</span>
                    ...
                    <div class="p-6">
                        ...
                        <div class="bg-gray-50 rounded-xl p-6 border-2 border-dashed border-gray-200 relative flex flex-col items-center justify-center">
                            ...
                            <div class="p-2 bg-white border rounded shadow-sm">
                                {!! QrCode::format('svg')->size(150)->generate($order->tickets->first()->code ?? 'ERROR') !!}
                            </div>
                    ...
                    <div class="bg-gray-50 px-6 py-3 border-t border-gray-100 flex justify-between items-center">
                        ...
                        <span class="text-gray-900 font-bold">${{ (int) $order->concert->price }}</span>
                    </div>
                </div>
            @endforeach
        </div>
